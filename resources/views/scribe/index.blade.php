    ...
    <div id="toc">
                ...
                <li class="tocify-item level-1" data-unique="authentication">
                    <a href="#authentication">Authentication</a>
                                ...
                                <a href="#authentication-POSTapi-v1-login">POST api/v1/login</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="authentication-POSTapi-v1-register">
                                <a href="#authentication-POSTapi-v1-register">POST api/v1/register</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="authentication-POSTapi-v1-logout">
                                <a href="#authentication-POSTapi-v1-logout">POST api/v1/logout</a>
                            </li>
                                                                        </ul>
                            </ul>
                ...
                <li class="tocify-item level-1" data-unique="email-verification">
                    <a href="#email-verification">Email verification</a>
                                    ...
                                    <ul id="tocify-subheader-email-verification" class="tocify-subheader">
                                                    <li class="tocify-item level-2" data-unique="email-verification-POSTapi-v1-email-verification-notification">
                                <a href="#email-verification-POSTapi-v1-email-verification-notification">POST api/v1/email/verification-notification</a>
                            </li>
                ...
                <li class="tocify-item level-1" data-unique="reset-password">
                    <a href="#reset-password">Reset password</a>
                                    ...
                                    <ul id="tocify-subheader-reset-password" class="tocify-subheader">
                                                    <li class="tocify-item level-2" data-unique="reset-password-POSTapi-v1-password-reset-notification">
                                <a href="#reset-password-POSTapi-v1-password-reset-notification">POST api/v1/password/reset-notification</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="reset-password-POSTapi-v1-password-reset">
                                <a href="#reset-password-POSTapi-v1-password-reset">POST api/v1/password/reset</a>
                            </li>
                                                                        </ul>
                            </ul>
...
<p>You can retrieve your token by visiting your dashboard and clicking <b>Generate API token</b>.</p>
        ...
        <h1 id="authentication">Authentication</h1>
                                ...
                                <h2 id="authentication-POSTapi-v1-login">POST api/v1/login</h2>
...
<p>Example: <code>architecto</code></p>
                    ...
                    <h2 id="authentication-POSTapi-v1-register">POST api/v1/register</h2>
...
<span id="example-responses-POSTapi-v1-password-reset-notification">
</span>
<span id="execution-results-POSTapi-v1-password-reset-notification" hidden>
    <blockquote>Received response<span
                id="execution-response-status-POSTapi-v1-password-reset-notification"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-POSTapi-v1-password-reset-notification"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-POSTapi-v1-password-reset-notification" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-POSTapi-v1-password-reset-notification">
...
<form id="form-POSTapi-v1-password-reset-notification" data-method="POST"
      ...
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('POSTapi-v1-password-reset-notification', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-POSTapi-v1-password-reset-notification"
                    onclick="tryItOut('POSTapi-v1-password-reset-notification');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-POSTapi-v1-password-reset-notification"
                    onclick="cancelTryOut('POSTapi-v1-password-reset-notification');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-POSTapi-v1-password-reset-notification"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="POSTapi-v1-password-reset-notification"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="POSTapi-v1-password-reset-notification"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
